    ...
    <section
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-lavender-200 via-lavender-300 to-lavender-200 -translate-x-1/2" />
          ...
          <div className="space-y-20 md:space-y-28">
            ...
            <AnimatedSection
              ...
              <div className="absolute left-6 md:left-1/2 -translate-x-1/2 mt-2 md:mt-0 z-10">
                <div className="relative w-4 h-4">
                  <div className="w-4 h-4 bg-lavender-300 rounded-full shadow-[0_0_0_4px_rgba(200,162,200,0.2)]" />
                  <div className="absolute inset-0 rounded-full bg-lavender-300 opacity-40 animate-ping" style={{ animationDuration: '2s' }} />
                </div>
              </div>
              ...
              <div className="ml-14 md:ml-0 md:w-1/2 md:pl-16">
                <div className="inline-block px-4 py-1.5 bg-lavender-100 border border-lavender-200 text-lavender-600 font-sans text-xs tracking-[0.2em] uppercase mb-4 rounded-full">
                  December 11, 2021
                </div>
            ...
            <AnimatedSection
              ...
              <div className="absolute left-6 md:left-1/2 w-4 h-4 bg-rose rounded-full -translate-x-1/2 mt-2 md:mt-0 shadow-[0_0_0_4px_rgba(212,132,154,0.2)] z-10" />
            ...
            <AnimatedSection
              ...
              <div className="absolute left-6 md:left-1/2 w-4 h-4 bg-lavender-300 rounded-full -translate-x-1/2 mt-2 md:mt-0 shadow-[0_0_0_4px_rgba(200,162,200,0.2)] z-10" />
              ...
              <div className="hidden md:flex md:w-1/2 md:pl-16 justify-start">
                <motion.div
                  ...
                  <img
                    ...
                    className="w-52 h-40 object-cover rounded-sm opacity-90" />
                </motion.div>
              </div>
            ...
            <AnimatedSection
              ...
              <div className="ml-14 md:ml-0 md:w-1/2 md:pl-16">
                <div className="inline-block px-4 py-1.5 bg-rose-light/50 border border-rose-light text-rose font-sans text-xs tracking-[0.2em] uppercase mb-4 rounded-full">
                  June 4, 2026
                </div>
                <h3 className="font-serif text-2xl md:text-3xl text-wedding-text mb-3">
